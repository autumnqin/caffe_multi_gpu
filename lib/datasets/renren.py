...
class renren(imdb):
    def __init__(self, image_set, index, devkit_path=None):
        imdb.__init__(self, 'renren' + index + '_' + image_set)
        self._index = index
        ...
        assert os.path.exists(self._devkit_path), \
                'renren path does not exist: {}'.format(self._devkit_path)
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'renren' + self._index)
    ...
    def selective_search_roidb(self):
        ...
        if int(self._index) == 1 or self._image_set != 'test':
    ...
    def _do_python_eval(self, output_dir = 'output'):
        ...
        use_07_metric = True if int(self._index) < 2 else False
...
if __name__ == '__main__':
    from datasets.renren import renren
    d = renren('trainval', '1')
    res = d.roidb
